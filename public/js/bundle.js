...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3Vwb2xlbyIsImEiOiJjbDJ6c2x3NmYwMHduM2JxdWhmank5aWloIn0.PuKnJ0oBPYOXLrGv6k-Emw';
...
// DOM ELEMENTS
var mapBox = document.getElementById('map'); // const signupForm = document.querySelector('.form--signup');

var loginForm = document.querySelector('.form--login');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data'); // const userPasswordForm = document.querySelector('.form-user-password');
